...
class cf_tracker():
    ...
    def initialize(self, image, region):
        ...
        self.gauss_peak = create_gauss_peak((self.region_width, self.region_height), 1)
    ...
    def track(self, image):
        ...
        template, mask = get_patch(image, (self.x, self.y), (self.region_width, self.region_height))
